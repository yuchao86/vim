...
set cursorline              "为光标所在行高亮当前行
set number                  "显示行号
set autoread                "文件在Vim之外修改过，自动重新读入
set autoindent              "set autoindent自动检测文件类型"

set ignorecase              "检索时忽略大小写
"set encoding=gbk
set fileencodings=utf8,gbk "使用utf-8或gbk打开文件
set hls                     "检索时高亮显示匹配项
...
Bundle 'vim-scripts/bookmarks.vim'
...
Bundle 'vim-scripts/java_src_link.vim'
Bundle 'vim-scripts/JavaKit'
...
" ...
Bundle 'file:///usr/local/go/misc/vim'
...
"let g:tagbar_ctags_bin='C:\Go\bin\ctags.exe'
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""
"let $JAVASOURCEPATH="E:\ucfpay\trunk\user\JavaSource\,D:\Java\jdk1.6.0_10\src\ "
...
""""""""""""""""""""""""""""""
"let Tlist_Ctags_Cmd = "C:\Go\bin\ctags.exe"
...
let g:T_AUTHOR = "Yu Chao"
let g:T_AUTHOR_EMAIL = "yuchao86@sina.cn"
...
set tags+=~/.vim/tags/c
" load web yii framework
set tags+=~/.vim/tags/yii
